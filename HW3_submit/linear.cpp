...
//     string test_allTrue2[] = {"1346", "2465", "5795", "35473", "5865"};
//     assert(allTrue(test_allTrue, 5));
//     assert(!allTrue(test_allTrue2, 5));
    
//     string test_countFalse[] = {"1243", "2463", "234", "23"};
//     assert(countFalse(test_countFalse, 4)==2);
//     assert(countFalse(test_allTrue2, 5)==1);
//     assert(countFalse(test_allTrue, 5)==0);    
    
//     string test_firstFalse[] = {"2353", "2645", "234", "2354"};
//     string fiveTrues[] = {"6343", "9254", "3654", "6767", "2040"};
//     assert(firstFalse(fiveTrues, 5) == -1);
//     assert(firstFalse(test_firstFalse, 4) == 2);
//     assert(firstFalse(test_allTrue2, 5) == 3);
//     assert(firstFalse(test_countFalse, 4) == 2);
//     assert(firstFalse(test_allTrue, 5) == -1);
    
//     string test_indexOfLeast[] = {"1253", "2343", "7353", "9999", "4354", "3453"};
//     string empty[] = {""};
//     assert(indexOfLeast(empty, 0)== -1);
//     assert(indexOfLeast(test_indexOfLeast, 6)== 0);
//     assert(indexOfLeast(test_allTrue, 5) == 0);
//     assert(indexOfLeast(test_firstFalse, 4)== 2);
