...
//   string b1[] = {"abc", "abc", "def", "ghi", "def", "xyz", "tuv", "ijk"};
//     string b21[] = {"abc", "ghi", "ijk"};
//     string b22[] = {"abc", "def", "tuv"};
//     string b23[] = {"def", "xyz", "ijk"};
//     assert(countIncludes(b1, 8, b21, 3)==2);
//     assert(countIncludes(b1, 8, b22, 3)==4);
//     assert(countIncludes(b1, 8, b23, 3)==2);
...
//     }
//     cout<<endl;
//     string test2[] = {"d", "t", "z", "a", "p", "r", "w", "l", "z", "v", "d", "n", "j"};
//     order(test2, 13);
