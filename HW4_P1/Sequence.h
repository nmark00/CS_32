...
// using ItemType = <em>some type</em>;
...
template <typename ItemType> int subsequence(const Sequence<ItemType>& seq1, const Sequence<ItemType>& seq2);
...
template <typename ItemType> void interleave(const Sequence<ItemType>& seq1, const Sequence<ItemType>& seq2, Sequence<ItemType>& result);
      // Set result to a Sequence that interleaves seq1 and seq2.


// Inline implementations
 
template <typename ItemType> inline int Sequence<ItemType>::size() const
{
    return m_size;
}

template <typename ItemType> inline bool Sequence<ItemType>::empty() const
{
    return size() == 0;
}
...
Sequence<ItemType>::Node* Sequence<ItemType>::doErase(Node* p)
{
...
template <typename ItemType> typename
Sequence<ItemType>::Node* Sequence<ItemType>::nodeAtPos(int pos) const
{
    Node* p;
