...
//    assert(runtest("/Users/nicholasmark/Downloads/tractatus1.txt", "/Users/nicholasmark/Downloads/tractatus1.txt",
//                   "/Users/nicholasmark/Downloads/p4test/diff.txt", "/Users/nicholasmark/Downloads/p4test/newfile.txt"));
//
    
//================================================================================
    ifstream infile1("/Users/nicholasmark/Downloads/tractatus1.txt");
    if ( ! infile1 )                // Did opening the file fail?
    {
        cerr << "Error: Cannot open greeneggs1.txt!" << endl;
        return 1;
    }
    ifstream infile2("/Users/nicholasmark/Downloads/tractatus2-2.txt");
